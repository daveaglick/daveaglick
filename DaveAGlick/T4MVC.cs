...
{
    public static DaveAGlick.Controllers.BackendController Backend = new DaveAGlick.Controllers.T4MVC_BackendController();
    public static DaveAGlick.Controllers.BlogController Blog = new DaveAGlick.Controllers.T4MVC_BlogController();
    public static DaveAGlick.Controllers.ErrorController Error = new DaveAGlick.Controllers.T4MVC_ErrorController();
    public static DaveAGlick.Controllers.HomeController Home = new DaveAGlick.Controllers.T4MVC_HomeController();
    public static DaveAGlick.Controllers.NuGetStatsController NuGetStats = new DaveAGlick.Controllers.T4MVC_NuGetStatsController();
    public static DaveAGlick.Controllers.ProjectsController Projects = new DaveAGlick.Controllers.T4MVC_ProjectsController();
    public static DaveAGlick.Controllers.WordPressRedirectsController WordPressRedirects = new DaveAGlick.Controllers.T4MVC_WordPressRedirectsController();
